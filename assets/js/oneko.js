...
(function oneko() {
  ...
  function frame() {
    ...
    if (isDragging) {
      // alternate between scratchWallN and scratchWallW every 2 frames for squirming effect
      const squirmSprite = Math.floor(frameCount / 2) % 2 === 0 ? "scratchWallN" : "scratchWallW";
      setSprite(squirmSprite, frameCount);
      return;
    }
